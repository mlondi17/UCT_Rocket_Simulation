...
Launch_Rod_Length = 1.8;                  % Length of launch rod (m)
Mass_Rocket_With_Motor = 0.787;       % Mass with motor (kg)
Mass_Rocket_Without_Motor = 0.65;     % Mass without motor (kg)

Theta(1) = 0;                  % Initial angle (deg)
